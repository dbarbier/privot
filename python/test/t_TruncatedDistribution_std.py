...
try :
    ...
    referenceDistribution = [TruncatedNormal(2.0, 1.5, 1.0, 4.0), TruncatedNormal(2.0, 1.5, 1.0, 200.0), TruncatedNormal(2.0, 1.5, -200.0, 4.0)]
    distribution = [TruncatedDistribution(Normal(2.0, 1.5), 1.0, 4.0), TruncatedDistribution(Normal(2.0, 1.5), 1.0, TruncatedDistribution.LOWER), TruncatedDistribution(Normal(2.0, 1.5), 4.0, TruncatedDistribution.UPPER)]
    for testCase in range(3):
        ...
        for i in range(6):
            print "standard moment n=", i, " value=", referenceDistribution[testCase].getStandardMoment(i)
        print "Standard representative=", referenceDistribution[testCase].getStandardRepresentative()

except :
    import sys
    print "t_TruncatedDistribution_std.py", sys.exc_type, sys.exc_value
