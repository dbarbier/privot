...
try :
    ...
    limitState.setGradientImplementation(CenteredFiniteDifferenceGradient(ResourceMap.GetAsNumericalScalar("CenteredFiniteDifferenceGradient-DefaultEpsilon"), limitState.getEvaluationImplementation()))
    limitState.setHessianImplementation(CenteredFiniteDifferenceHessian(ResourceMap.GetAsNumericalScalar("CenteredFiniteDifferenceHessian-DefaultEpsilon"), limitState.getEvaluationImplementation()))
    ...
    import sys
    print "t_Waarts_system_series.py", sys.exc_type, sys.exc_value
