...
try :
    ...
    coefficients[0] = 0.3
    coefficients[1] = 2.9
    myHessian = LinearCombinationHessianImplementation(LinearCombinationEvaluationImplementation(functions, coefficients))
    ...
    import sys
    print "t_LinearCombinationHessianImplementation_std.py", sys.exc_type, sys.exc_value
