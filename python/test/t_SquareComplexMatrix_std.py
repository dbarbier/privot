...
try :
    ...
    # Default constructor
    squareComplexMatrix0 = SquareComplexMatrix()
    ...
    squareComplexMatrix1 = SquareComplexMatrix(2)
    ...
    # Copy constructor
    squareComplexMatrix2 = SquareComplexMatrix(squareComplexMatrix1)
    ...
    pt = NumericalComplexCollection(2)
    pt[0] = 1.+ 1j
    pt[1] = 1j
    print  "pt = " , repr(pt)
    ...
    squareComplexMatrix5 = SquareComplexMatrix()
    squareComplexMatrix6 = SquareComplexMatrix()
    ...
    import sys
    print "t_SquareComplexMatrix_std.py", sys.exc_type, sys.exc_value
