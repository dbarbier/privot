...
try :
    ...
    testVal = 0.372
    testThres = 0.42
    testResultTest = TestResult(type, testBool, testVal, testThres)
    ...
    print "testResultTest2 binary quality measure = " , testResultTest.getBinaryQualityMeasure()
    print "testResultTest2 p value = %.6f" % testResultTest.getPValue()
    print "testResultTest2 p value threshold = %.6f" % testResultTest.getThreshold()
    ...
    testValDiff = 0.02
    testThresDiff = 0.12
    testResultTestDiff = TestResult(typeDiff, testBoolDiff, testValDiff, testThresDiff)
    print "testResultTestDiff = testResultTest " , (testResultTestDiff == testResultTest)

except  :
    import sys
    print "t_TestResult_std.py", sys.exc_type, sys.exc_value
