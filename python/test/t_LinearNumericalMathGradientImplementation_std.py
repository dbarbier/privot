...
try :
    ...
    myGradient = LinearNumericalMathGradientImplementation(center, constant, linear)
    ...
    import sys
    print "t_LinearNumericalMathGradientImplementation_std.py", sys.exc_type, sys.exc_value
