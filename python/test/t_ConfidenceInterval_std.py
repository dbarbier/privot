...
try :
    ...
    print "testInterval2 values = " , testInterval2.getFirst() , "  " , testInterval2.getLast()
    print "testInterval  values = " , testInterval.getFirst() , "  " , testInterval.getLast()
    ...
    import sys
    print "t_ConfidenceInterval_std.py", sys.exc_type, sys.exc_value
