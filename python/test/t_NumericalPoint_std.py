...
try :
    ...
    if ref_point2 != ref_point2:
        print "OT::Base::Type::NumericalPoint.operator == does NOT return the correct value. Says that point2 and point2 are DIFFERENT though they are equal."
        raise RuntimeError()

    if ref_point2 == ref_point3:
        print "OT::Base::Type::NumericalPoint.operator == does NOT return the correct value. Says that point2 and point3 are EQUAL though they are different."
        raise RuntimeError()
