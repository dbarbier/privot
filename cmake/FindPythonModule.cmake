...
#  MODULE_VERSION - module version, if available through __version__
#
#=============================================================================
  ...
  if ( NOT ${module_upper}_FOUND )
    ...
    if ( NOT _${module}_status )
      ...
      execute_process ( COMMAND "${PYTHON_EXECUTABLE}" "-c" "import ${module}; print( ${module}.__version__ )"
                        ...
                        ERROR_QUIET OUTPUT_STRIP_TRAILING_WHITESPACE )
      if ( NOT _${module}_status )
        set ( ${module_upper}_VERSION ${_${module}_version}
              CACHE STRING "Version of Python module ${module}" )
              
        set ( _${module_upper}_VERSION_MATCH TRUE )      
        if ( ${module}_FIND_VERSION VERSION_GREATER ${module_upper}_VERSION )
          set ( _${module_upper}_VERSION_MATCH FALSE )      
        endif ()
        mark_as_advanced ( ${module_upper}_VERSION )
      endif ()
    endif ()
