...
{
  checkHermitian();
  return SquareComplexMatrix::clean(0.0).__str__();
}
...
{
  return TriangularComplexMatrix(Implementation(getImplementation()->computeCholesky(keepIntact).clone()), 'L');
}
