 ...
 *  Id      NumericalSampleImplementation.hxx 2491 2012-04-18 15:56:46Z schueller
 */
...
public:
  ...
  static NumericalSampleImplementation GetFromFile(const FileName & fileName,
                                                   const String & parameters = "",
                                                   const ExternalFileFormat format = CSV);
