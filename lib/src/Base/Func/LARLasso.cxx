...
/* Default constructor */
LARLasso::LARLasso(const Bool verbose)
...
/* Virtual constructor */
LARLasso * LARLasso::clone() const
{
  return new LARLasso( *this );
}

/* Method to create new BasisSequence objects */
BasisSequence LARLasso::build(const NumericalSample & x,
...
/* String converter */
String LARLasso::__repr__() const
{
  return OSS() << "class=" << GetClassName();
}

String LARLasso::__str__(const String & offset) const
{
...
void LARLasso::save(Advocate & adv) const
{
  BasisSequenceFactoryImplementation::save(adv);
}

/* Method load() reloads the object from the StorageManager */
void LARLasso::load(Advocate & adv)
{
