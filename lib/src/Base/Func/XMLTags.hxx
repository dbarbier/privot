 ...
 *  Id      XMLTags.hxx 2392 2012-02-17 18:35:43Z schueller
 */
...
const char * const XMLTag_component_name    = "component-name";
...
const char * const XMLTag_framework         = "framework";
...
const char * const XMLTag_study_id          = "study-id";
const char * const XMLTag_study_case        = "study-case";
