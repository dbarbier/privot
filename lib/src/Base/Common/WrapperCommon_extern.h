...
extern void wrapper_setError(void * p_error, const char * format, ...);
...
extern void wrapper_printUserMessage(const char * functionName, const char * format, ...);

/* Print out the info message passed as argument */
extern void wrapper_printInfoMessage(const char * functionName, const char * format, ...);

/** Print out the message passed as argument */
extern void wrapper_printMessage(const char * functionName, const char * format, ...);
...
extern void wrapper_printState(const char * functionName, void * p_state);

/** Print out the content of the WrapperExchangedData structure */
extern void wrapper_printWrapperExchangedData(const char * functionName, const struct WrapperExchangedData * p_exchangedData);

/* Print out the content of the WrapperInformation structure */
extern void wrapper_printWrapperInformation(const char * functionName, const struct WrapperInformation * p_info);

/* Print out the content of a point structure */
extern void wrapper_printPoint(const char * functionName, const struct point * p_point);

/* Print out the content of a sample structure */
extern void wrapper_printSample(const char * functionName, const struct sample * p_sample);

/* Print out the content of a timeseries structure */
extern void wrapper_printTimeSeries(const char * functionName, const struct timeseries * p_timeseries);

/* Print out the content of a matrix structure */
extern void wrapper_printMatrix(const char * functionName, const struct matrix * p_matrix);

/* Print out the content of a tensor structure */
extern void wrapper_printTensor(const char * functionName, const struct tensor * p_tensor);
...
extern unsigned long wrapper_getNumberOfVariables(const struct WrapperExchangedData * p_exchangedData, unsigned long type);

/* Get the number of files of some type (in or out) in the data read from the description file */
extern unsigned long wrapper_getNumberOfFiles(const struct WrapperExchangedData * p_exchangedData, unsigned long type);

/* Deep copy of a WrapperExchangedData structure (returns non-zero if error occured) */
extern long wrapper_copyWrapperExchangedData(struct WrapperExchangedData ** p_p_new_exchangedData, const struct WrapperExchangedData * p_exchangedData, void * p_error);
...
extern const struct WrapperVariableListElement * wrapper_getVariableById(const struct WrapperExchangedData * p_exchangedData, const char * id);

/* Get a pointer to a file structure. NULL if not found */
extern const struct WrapperFileListElement * wrapper_getFileById(const struct WrapperExchangedData * p_exchangedData, const char * id);
 ...
 */
extern char * wrapper_createTemporaryDirectory(const char * tempDirPrefix, const struct WrapperExchangedData * p_exchangedData, void * p_error);
 ...
 * directory is erased.
 */
extern void wrapper_deleteTemporaryDirectory(char * tempDir, long executionStatus, void * p_error);
 ...
 */
extern long wrapper_createInputFiles(const char * directory, const struct WrapperExchangedData * p_exchangedData, const struct point * p_point, void * p_error);
 ...
 */
extern long wrapper_readOutputFiles(const char * directory, const struct WrapperExchangedData * p_exchangedData, struct point * p_point, void * p_error);
 ...
 * using free.
 */
extern char * wrapper_makeCommandFromTemplate(const char * command, const struct WrapperExchangedData * p_exchangedData, const struct point * p_point, void * p_error);

#ifndef WIN32
/* Create a batch script in the general temporary directory for use by insulateCommand() */
extern char * wrapper_makeScript(char * command, const char * directory, const struct WrapperExchangedData * p_exchangedData, void * p_error);
#endif

/* Insulate a shell command, so that it can be run in a random temporary directory */
extern char * wrapper_insulateCommand(char * command, const char * temporaryDir, const struct WrapperExchangedData * p_exchangedData, void * p_error);

/* Run an insulated command based on the template read from the wrapper description file */
extern long wrapper_runInsulatedCommand(const char * temporaryDir, const struct WrapperExchangedData * p_exchangedData, const struct point * p_point, void * p_error);
