...
void SequentialStrategy::updateBasis(const NumericalPoint & alpha_k_p_,
  ...
  if (verbose_)
    {
      ...
      LOGINFO(OSS() << "  coeffs   size=" << alpha_k_p_.getSize());
      LOGINFO(OSS() << "  coeffs       =" << alpha_k_p_);
