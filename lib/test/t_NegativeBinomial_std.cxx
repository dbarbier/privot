//                                               -*- C++ -*-
/**
 *  @file  t_NegativeBinomial_std.cxx
...
{
public:
  explicit TestObject() : NegativeBinomial(4.5, 0.7) {}
  explicit TestObject(const String & name) : NegativeBinomial(4.5, 0.7)
  {
    setName(name);
  }
  virtual ~TestObject() {}
  ...
  try
    {
      ...
      NegativeBinomial::NumericalPointWithDescriptionCollection parameters = distribution.getParametersCollection();
