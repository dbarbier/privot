...
#define WRAPPERNAME TestCompositionLeft

BEGIN_C_DECLS

WRAPPER_BEGIN

static struct WrapperInformation info_TestCompositionLeft = {/* inSize_  = */ 2,
                                                             /* outSize_ = */ 3
};
...
FUNC_INFO( WRAPPERNAME , { *p_info = info_TestCompositionLeft; } )
...
GRAD_INFO( WRAPPERNAME , { *p_info = info_TestCompositionLeft; } )
...
HESS_INFO( WRAPPERNAME , { *p_info = info_TestCompositionLeft; } )
