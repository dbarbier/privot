//                                               -*- C++ -*-
/**
 *  @file  t_NatafIndependentCopulaHessian_std.cxx
 *  @brief The test file of class NatafIndependentCopulaHessian for standard methods
 *
...
int main(int argc, char *argv[])
{
  ...
  try
    {
      UnsignedLong dim(2);
      NatafIndependentCopulaHessian transformation(dim);
