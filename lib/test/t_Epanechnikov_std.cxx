//                                               -*- C++ -*-
/**
 *  @file  t_Epanechnikov_std.cxx
 *  @brief The test file of class Epanechnikov for standard methods
 *
...
class TestObject : public Epanechnikov
{
public:
  explicit TestObject() : Epanechnikov() {}
  explicit TestObject(const String & name) : Epanechnikov()
  {
    setName(name);
  }
  virtual ~TestObject() {}
  ...
  try
    {
      ...
      Epanechnikov::NumericalPointWithDescriptionCollection parameters = distribution.getParametersCollection();
