...
{
public:
  explicit TestObject() : Logistic(-0.5, 1.5) {}
  explicit TestObject(const String & name) : Logistic(-0.5, 1.5)
  {
    setName(name);
  }
  virtual ~TestObject() {}
  ...
  try
    {
      ...
      Logistic::NumericalPointWithDescriptionCollection parameters = distribution.getParametersCollection();
