...
{
public:
  explicit TestObject() : Laplace(1.5, 0.5) {}
  explicit TestObject(const String & name) : Laplace(1.5, 0.5)
  {
    setName(name);
  }
  virtual ~TestObject() {}
  ...
  try
    {
      ...
      Laplace::NumericalPointWithDescriptionCollection parameters = distribution.getParametersCollection();
