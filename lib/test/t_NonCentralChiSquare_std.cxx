//                                               -*- C++ -*-
/**
 *  @file  t_NonCentralChiSquare_std.cxx
 *  @brief The test file of class NonCentralChiSquare for standard methods
 *
...
class TestObject : public NonCentralChiSquare
{
public:
  explicit TestObject() : NonCentralChiSquare(1.5, 2.5) {}
  explicit TestObject(const String & name) : NonCentralChiSquare(1.5, 2.5)
  {
    setName(name);
  }
  virtual ~TestObject() {}
  ...
  try
    {
      ...
      NonCentralChiSquare distribution(1.5, 2.5);
      ...
      NonCentralChiSquare::NumericalPointWithDescriptionCollection parameters = distribution.getParametersCollection();
