 ...
 *
 *  @author dutka
 *  @date   2011-01-24 11:22:38 +0100 (lun. 24 janv. 2011)
 */
#include "OT.hxx"
...
{
public:
  explicit TestObject() : FisherSnedecor(5.5, 10.5) {}
  explicit TestObject(const String & name) : FisherSnedecor(5.5, 10.5)
  {
    setName(name);
  }
  virtual ~TestObject() {}
  ...
  try
    {
      ...
      FisherSnedecor distribution(5.5, 10.5);
      ...
      FisherSnedecor::NumericalPointWithDescriptionCollection parameters = distribution.getParametersCollection();
