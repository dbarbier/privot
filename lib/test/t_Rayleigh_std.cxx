...
class TestObject : public Rayleigh
{
public:
  explicit TestObject() : Rayleigh(2.5, -0.5) {}
  explicit TestObject(const String & name) : Rayleigh(2.5, -0.5)
  {
    setName(name);
  }
  virtual ~TestObject() {}
  ...
  try
    {
      ...
      Rayleigh::NumericalPointWithDescriptionCollection parameters = distribution.getParametersCollection();
      ...
      NumericalScalar gamma(distribution.getGamma());
