 ...
 *
 *  @author lebrun
 *  @date   2011-06-16 14:53:58 +0200 (jeu. 16 juin 2011)
 */
#include "OT.hxx"
...
class TestObject : public LogUniform
{
public:
  explicit TestObject() : LogUniform(-0.5, 1.5) {}
  explicit TestObject(const String & name) : LogUniform(-0.5, 1.5)
  {
    setName(name);
  }
  virtual ~TestObject() {}
