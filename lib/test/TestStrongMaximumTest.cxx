//                                               -*- C++ -*-
/**
 *  @file  TestStrongMaximumTest.cxx
 *  @brief
 *
...
#define WRAPPERNAME TestStrongMaxTest

BEGIN_C_DECLS

WRAPPER_BEGIN

static struct WrapperInformation info_TestStrongMaxTest = {/* inSize_  = */ 2,
                                                           /* outSize_ = */ 1
};
...
FUNC_INFO( WRAPPERNAME , { *p_info = info_TestStrongMaxTest; } )
...
GRAD_INFO( WRAPPERNAME , { *p_info = info_TestStrongMaxTest; } )
...
HESS_INFO( WRAPPERNAME , { *p_info = info_TestStrongMaxTest; } )
