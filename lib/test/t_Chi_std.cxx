...
{
public:
  explicit TestObject() : Chi(1.5) {}
  explicit TestObject(const String & name) : Chi(1.5)
  {
    setName(name);
  }
  virtual ~TestObject() {}
  ...
  try
    {
      ...
      Chi::NumericalPointWithDescriptionCollection parameters = distribution.getParametersCollection();
