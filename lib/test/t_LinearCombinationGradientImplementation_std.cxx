//                                               -*- C++ -*-
/**
 *  @file  t_LinearCombinationGradientImplementation_std.cxx
 *  @brief The test file of class LinearCombinationGradientImplementation for standard methods
 *
  ...
  try
    {
      ...
      coefficients[0] = 0.3;
      coefficients[1] = 2.9;
      LinearCombinationGradientImplementation myGradient(LinearCombinationEvaluationImplementation(functions, coefficients));
