//                                               -*- C++ -*-
/**
 * @file  t_RestrictedHessianImplementation_std.cxx
 * @brief The test file of class RestrictedHessianImplementation for standard methods
 *
  ...
  try
    {
      ...
      RestrictedHessianImplementation restriction(hessian, restrictionIndices, referencePoint);
      fullprint << "restricted hessian=" << restriction << std::endl;
      NumericalPoint point(2);
      point[0] =  4.0;
      point[1] = -4.0;
      fullprint << "value at " << point << "=" << restriction.hessian(point) << std::endl;
      point = referencePoint;
      point[1] =  4.0;
      point[2] = -4.0;
      fullprint << "reference value=" << hessian.hessian(point) << std::endl;
    }
  catch (TestFailed & ex)
    {
