...
{
public:
  explicit TestObject() : Geometric(0.7) {}
  explicit TestObject(const String & name) : Geometric(0.7)
  {
    setName(name);
  }
  virtual ~TestObject() {}
  ...
  try
    {
      ...
      Geometric::NumericalPointWithDescriptionCollection parameters = distribution.getParametersCollection();
