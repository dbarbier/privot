//                                               -*- C++ -*-
/**
 *  @file  t_NumericalMathFunction_hess.cxx
 *  @brief The test file of class NumericalMathFunction for hessian method
 *
  ...
  try
    {
      ...
      SymmetricTensor tensor = deviation.hessian( inPoint );
