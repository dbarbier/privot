...
\requirements{
  \begin{description}
  \item[$\bullet$] a collection of distribution, \textit{myCollection}
  \item[type:] a PythonDistribution
  \item[$\bullet$] a deterministic matrix of transformation, \textit{myMatrix}
  \item[type:] a Matrix
  \item[$\bullet$] a deterministic constant vector, \textit{myVector}
...
{
  \begin{description}
  \item[$\bullet$] the mean value: \textit{myMean},
  \item[type:] a NumericalPoint
  \item[$\bullet$] the standard deviation value: \textit{myStandardDeviation},
  \item[type:] a NumericalPoint
  \item[$\bullet$] the covariance matrix: \textit{myCovarianceMatrix},
  \item[type:] a CovarianceMatrix
  \item[$\bullet$] a realization of the distribution: \textit{myRealization},
  \item[type:] a NumericalPoint
  \item[$\bullet$] some realization of the distribution: \textit{mySample},
...
\requirements{
  \begin{description}
  \item[$\bullet$] the point of interest, \textit{myPoint}
  \item[type:] a NumericalPoint
  \end{description}
}
{
  \begin{description}
  \item[$\bullet$] probability density value: \textit{myPDF},
  \item[type:] a NumericalScalar
  \item[$\bullet$] the characteristic function value: \textit{myCF},
