...
\begin{align}
  ...
  E_{m_1,\hdots,m_d}(k_1,\hdots,k_d)&=e^{-i\sum_{j=1}^d k_jh_j\left(\mu_j+b\left(\frac{2m_j+1}{M}-1\right)\sigma_j\right)}\label{Eq:E}
\end{align}
...
Symmetry of $\delta$ implies that for all $(k_1, k_2)$,
\begin{align}
...
We apply a change of variables $k_1'=k_1+1$, $k_2'=N-k_2$:
\begin{align*}
\Sigma_{m_1,m_2}^{+-}&=\sum_{k_1=0}^{N-1}\sum_{k_2=0}^{N-1}
