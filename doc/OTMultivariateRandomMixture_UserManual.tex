...
\item[Some methods :]  \strut
  ...
  \item $computeCharacteristicFunction$
    ...
    \end{description}
    \item[Value :] a $NumericalComplex$, performs the characteristic function on $u$
    \end{description}
  ...
  \item $computeLogCharacteristicFunction$
    ...
    \begin{description}
      \item $u$ : a NumericalPoint of dimension $n \ge 1$
    \end{description}
    \item[Value :] a $NumericalComplex$, performs the log-characteristic function on $u$
    \end{description}
  ...
  \item $setReferenceBandwidth$
    ...
    \item[Arguments :]  \strut
    \begin{description}
      \item $bandwidth$, a $NumericalScalar$
    \end{description}
